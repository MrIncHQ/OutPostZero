...
export class UnifiedSearchService {
  constructor(private readonly database: DatabaseService, private readonly documents: DocumentService) {}
  search(query: string): UnifiedSearchResult[] {
    ...
    return [...noteResults, ...documentResults, ...mapResults].slice(0, 80);
  }
}
