...
Future downloadable module packages must follow the same verified lifecycle used by the Kiwix engine:
...
5. Start the module with its allowlisted portable runtime and portable temp/data paths.
